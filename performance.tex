...
sub/woofers for the low frequency bands and occasionally mid-range speakers etc. with individual drivers. Even different components are 
utilized, the resulting harmony of these components lead to a very satisfactory listening experince if compared to a generic single driver
