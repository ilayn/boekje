...
If compared to the results of \cite{jazayeri}, terms involving the bound $b$ don't vanish. In fact, the authors prove the test for a half-plane defined 
as $\left\{z\in\Complex|\Re{z}\geq a\right\}$ instead of a strip and the necessity direction of the proof is omitted. Hence, the upper 
bound on the real part of the uncertainty is not taken into account. Thus, their result is similar to the condition given in \Cref{thm:desvidpass}.
