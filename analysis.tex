...
\]
The overall teleoperation system is {then described}, with $Y_m(s) = \inv{(M_ms+B_m)}$ and $Y_s(s) = \frac{\mu K_p}{M_s s^2+(B_s+K_v)s+K_p}$, in terms of the following admittance matrix:
\begin{equation}
