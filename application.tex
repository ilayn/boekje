...
in \Cref{lit:syn:ela} are assumed to be zero and the number of variables is reduced. In the four-channel case, the methods are exclusively 
...
transparency optimized control laws given above can only be taken into account in the passivity-based absolute stability framework.
