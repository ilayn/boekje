...
In this section we will refer to the designed controllers by $C_1,C_{21},C_{22},C_3$. First, the frequency domian properties 
are listed in \Cref{fig:app:contredmass,fig:app:incr}. 
    ...
    \xdef\myx{\xind}
        ...
        \xdef\myxy{\myx\yind}
            ...
            \pgfplotsforeachungrouped\z in {0,...,2}{
                \begingroup\xdef\temp{\endgroup\noexpand\addplot+[] table[x=f,y=k\myxy] {plotdata/krobd\z.dat};}\temp%
            }
        }
    }
    \end{groupplot}
\end{tikzpicture}
\caption{The frequency domain data of the controllers designed for fixed human mass parameter. Solid: $C_1$, dashed: $C_{21}$, dash-dotted: $C_{22}$}%
...
is not included in this draft. Missing a few experimental plots and interpretations.
Approx. 5 more pages to come.
} 
