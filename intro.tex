...
\textcolor{red}{After establishing this link with the methods in the literature we turn to the controller synthesis problem in \Cref{chap:synth}. We formulate the problem in a generalized plant framework and attempt to work out scarce details that are found in the literature to obtain a better model-based control synthesis algorithm.}  
