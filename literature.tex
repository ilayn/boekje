...
of stability characterization for LTI intereconnections was already well-known in SSV theory (e.g., \cite{packdoyle}) even at 
the time of writing. Therefore it is a misattribution.} that an apparently 
...
been possible had the tests not been exceedingly conservative since the real setups involve hard-contacts and time-varying systems. 
Once again, we remind the reader that the proper metrics to gauge the success of teleoperations is not known and we use the typical
error-norm based control design rationale. 
