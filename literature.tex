...
simultaneously by the same controller. that is performing sufficiently in order to ``fool'' the user such that the user feels 
...
Obviously once this transformation is introduced, there is a need for the ``inverse'' of $W$ on the operator that is seen
