...
This choice should be more apparent after \Cref{chap:perf}.
...
the three-carriage railcar with two cabs, is a valid, almost perfectly transparent two-port network with passive end terminations. Hence, a regular 
...
\begin{define}[Potential Instability at $\iw_0$] A two-port network is said to be potentially unstable at $\iw_0$ on the real frequency axis, 
