...
\begin{figure}%
\centering
\includegraphics[height=7cm]{images/literature/filament}%
...
In \cite{hashzaad2002}, the perfect transparency conditions are given for the undelayed case as the following;
If $C1,\cdots,C_6$ are not functions of $Z_h$ and $Z_e$, transparency is achieved if and only if the 
