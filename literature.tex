...
\draw[decoration=zigzag,decorate] (a) -- ($(myo.east)!0.80!(actin.north west)$)coordinate (b);
...
According to the articles given above, the muscle activation is analogous to a clock escapement mechanism \cite{headrick}. 
